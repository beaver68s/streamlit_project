...
Результаты теста были проведены с учетом следующих ограничений и предположений:

1. Выборка: **февраль**, данные по **БКИ** и **позиции оффера в выдаче**.
2. Считается, что пользователь кликнет на **ту же позицию оффера**, что и в исторических данных.
3. **Целевое действие** — это факт **отправки заявки** в финансовое учреждение *(не важно, был ли получен ответ)*.
""")
